...
In this hands-on lab, you’ll gain practical experience in building a vision-enabled chat application using **Azure AI Foundry**. You’ll learn how to create an AI project, deploy the **Phi-4-multimodal-instruct** model, and test it in the playground with both text and image inputs. Next, you’ll configure a Python client app in **Azure Cloud Shell**, connect it to your deployed model, and extend it to handle image prompts from both URLs and local files. By the end, you’ll know how to create, deploy, and consume a multimodal AI model, and integrate it into a custom Python application. 
