...
In this hands-on lab, you’ll explore how to analyze video content using **Azure Video Indexer**. You’ll begin by signing in to the Video Indexer portal and uploading a sample video for processing. Once indexed, you’ll review the automatically generated insights, including transcripts, OCR text, speakers, topics, keywords, sentiments, and detected entities. You’ll then practice searching for specific insights within the video and learn how to interact with the service programmatically through the **Video Indexer REST API**. Finally, you’ll embed **Video Indexer widgets** into a web page to share both the video and its insights with others. By the end of this lab, you’ll be able to use Video Indexer to extract, search, and present rich insights from video content for real-world applications.
