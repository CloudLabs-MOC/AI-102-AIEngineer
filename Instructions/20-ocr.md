...
1. In the top search bar, search for **Microsoft Foundry (1)**, select **Microsoft Foundry (2)** from the result.
    ...
    ![Visual Studio Code Icon](./images/ocr-t2p1.png)
...
1. On the **Microsoft Foundry** home page, from the left navigation menu, under **Classic AI services (1)**, select **Azure AI services multi-service account (classic) (2)**, and then click **+ Create (3)**.
    ...
    ![Visual Studio Code Icon](./images/ocr-t2p2.png)
...
1. In Visual Studio Code, in the **Explorer** pane, browse to the **20-ocr (1)** folder and expand the **C-Sharp (2)** folder depending on your language preference. Right-click the **read-text (3)** folder and select **Open in Integrated Terminal (4)**. 
...
2. In the **read-text/images** folder, right-click **Rome.pdf (1)** and select **Reveal in File Explorer (2)**.
