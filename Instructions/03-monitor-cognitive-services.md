...
1. In the **Aggregation** list, select **Count (3)**.  This will enable you to monitor the total calls to your Cognitive Service resource, which is useful in determining how much the service is being used over a period of time.
